...
|:---:|:---:|:---:|:---:|
| **105 distinct issue types detected** | **21 analysis engines** | **237 test assertions** | **56 test blocks** |
...
├── test-harness/                     # Fixture server + test runner (56 blocks, 237 hard assertions, 39 categories)
│   ├── README.md
