...
| Metric | Value |
| --- | --- |
| **Version** | `9.8.1` (security hardening — CodeQL TOCTOU + unused-var fixes, session/`.env` `0600`, `hono`+`form-data` CVE patches — plus the landing Growth section; published to npm, `action.yml` pinned to 9.8.1) |
| **Test blocks** | 166 |
| **Hard assertions** | 961 |
