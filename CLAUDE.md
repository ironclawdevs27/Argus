...
- Harness statistics (93 blocks, 394 hard assertions, 54 detection categories)
...
npm run test:harness  # Expected: 391/394 (3 permanent MCP-limited failures)
```
