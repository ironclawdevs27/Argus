...
- `enterprise_contacts (id, name, email, company, message, created_at)`
...
**Landing page** (`landing/`): React 18 + Vite + Tailwind + Framer Motion SPA with Supabase-backed waitlist and enterprise contact forms (Session 35, 2026-05-25). Sprint 0 mobile fixes (comparison table overflow, touch targets, video poster, `100dvh`, `prefers-reduced-motion`) are documented in `argus-vX1-roadmap.md` but not yet applied.
