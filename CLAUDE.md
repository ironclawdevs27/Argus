...
- Harness statistics (128 blocks, 544 hard assertions, 56 detection categories)
...
test-harness/
  validate.js                 — 128-block correctness harness (blocks [80]–[84] MCP/createFinding/withRetry/watch/init; [85]–[93] Sprint 0.5 Tier 3; [94]–[126] gap-close; [127] A7 theme; [128] D9 design fidelity)
  harness-config.js           — fixture page routing table
  pages/                      — 55 fixture HTML pages
...
npm run test:harness  # Expected: 541/544 (3 permanent MCP-limited failures)
```
