...
- Harness statistics (128 blocks, 565 hard assertions, 56 detection categories)
...
npm run test:harness  # Expected: 562/565 (3 permanent MCP-limited failures)
```
