...
- Harness statistics (127 blocks, 535 hard assertions, 55 detection categories)
...
test-harness/
  validate.js                 — 127-block correctness harness (blocks [80] MCP server, [81] createFinding, [82] withRetry, [83] watch dashboard, [84] cli/init.js; [85]–[93] Sprint 0.5 Tier 3 production-path regressions; [94]–[126] gap-close Sections 1–6; [127] Sprint 1 A7 theme)
...
npm run test:harness  # Expected: 532/535 (3 permanent MCP-limited failures)
```
