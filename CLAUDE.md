...
- Harness statistics (166 blocks, 961 hard assertions, 67 detection categories)
...
npm run test:unit          # 207 Vitest unit tests — no Chrome required
npm run test:harness       # Expected: 961/961 (no permanent failures); INFO logs suppressed via .env.harness
