...
- Harness statistics (129 blocks, 572 hard assertions, 57 detection categories)
...
npm run test:harness  # Expected: 569/572 (3 permanent MCP-limited failures)
```
