...
- Harness statistics (126 blocks, 528 hard assertions, 54 detection categories)
...
test-harness/
  validate.js                 — 126-block correctness harness (blocks [80] MCP server, [81] createFinding, [82] withRetry, [83] watch dashboard, [84] cli/init.js; [85]–[93] Sprint 0.5 Tier 3 production-path regressions; [94]–[126] gap-close Sections 1–6)
  harness-config.js           — fixture page routing table
  pages/                      — 53 fixture HTML pages
...
npm run test:harness  # Expected: 525/528 (3 permanent MCP-limited failures)
```
