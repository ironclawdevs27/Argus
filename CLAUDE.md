...
- Harness statistics (84 blocks, 367 hard assertions, 54 detection categories)
...
test-harness/
  validate.js                 — 84-block correctness harness (blocks [80] MCP server, [81] createFinding, [82] withRetry, [83] watch dashboard, [84] cli/init.js)
...
npm run test:harness  # Expected: 364/367 (3 permanent MCP-limited failures)
```
