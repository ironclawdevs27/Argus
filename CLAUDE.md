...
- Harness statistics (130 blocks, 581 hard assertions, 58 detection categories)
...
test-harness/
  validate.js                 — 129-block correctness harness (blocks [80]–[84] MCP/createFinding/withRetry/watch/init; [85]–[93] Sprint 0.5 Tier 3; [94]–[126] gap-close; [127] A7 theme; [128] D9 design fidelity; [129] Sprint 9 Web Vitals)
  harness-config.js           — fixture page routing table
  pages/                      — 57 fixture HTML pages
...
npm run test:harness  # Expected: 578/581 (3 permanent MCP-limited failures)
```
