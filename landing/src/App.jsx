...
const docChapters = [
  ...
  },
  {
    num: '05',
    title: 'Test Coverage',
    tagline: '83 blocks, 360 hard assertions, fixture-driven with zero ambiguity',
    sections: [
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Blocks 79–83: config validation, MCP server registration, createFinding(), withRetry(), watch dashboard',
...
npm run test:harness  # 360 hard assertions — Chrome required (headless)
# Expected: 357/360 (3 permanent MCP-limited failures: drag, Issues panel)
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto' }}>
        ...
        >
          ...
          <p style={{ margin: 0, maxWidth: 520, fontSize: 'clamp(0.9rem, 1.3vw, 1.05rem)', color: 'rgba(255,255,255,0.38)', lineHeight: 1.7 }}>
            From a single file to 83 test blocks — the engineering decisions, discoveries, and challenges behind Argus.
          </p>
        </motion.div>
