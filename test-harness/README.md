...
127 test blocks · 535 hard assertions · 48 verified detection categories · 54 fixture pages

> **Coverage note**: 55+ detection categories exist in production code. 48 are positively exercised by the harness (blocks [1]–[93] + [127]). Blocks [94]–[126] cover infrastructure contracts (module APIs, MCP transport, unhappy paths, CLI E2E) rather than new detection categories. Block [127] adds A7 Theme & Dark Mode. Remaining untriggered detections tracked in [argus-v6-strategy.md §10](../argus-v6-strategy.md).
...
**Expected output (532/535 — 3 permanent MCP-limited failures, exit code 0):**
...
────────────────────────────────────────────────────────
Results: 532/535 hard assertions passed, 3 failed
