...
126 test blocks · 528 hard assertions · 47 verified detection categories · 53 fixture pages

> **Coverage note**: 54+ detection categories exist in production code. 47 are positively exercised by the harness (blocks [1]–[93]). Blocks [94]–[126] cover infrastructure contracts (module APIs, MCP transport, unhappy paths, CLI E2E) rather than new detection categories. Remaining untriggered detections tracked in [argus-v6-strategy.md §10](../argus-v6-strategy.md).
...
**Expected output (525/528 — 3 permanent MCP-limited failures, exit code 0):**
...
────────────────────────────────────────────────────────
Results: 525/528 hard assertions passed, 3 failed
